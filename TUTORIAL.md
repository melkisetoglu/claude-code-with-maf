...
| 03 | [Tool-approval gate (`ToolApprovalAgent`)](tutorial/03-approval-gate.md) | ✅ done |
| 04 | [Mutation tools: `write_file`, `edit_file`, `bash` (gated by step 3)](tutorial/04-mutation-tools.md) | ✅ done |
...
| 10 | [Context compaction (`CompactionProvider`)](tutorial/10-compaction.md) | ✅ done |

### Milestone 5 — Memory & workflow
| # | Step | Status |
|---|---|---|
| 11 | [Project-context auto-load via `AgentSkillsProvider`](tutorial/11-skills.md) | ✅ done |
| 12 | [Cross-session memory via `FileMemoryProvider`](tutorial/12-memory.md) | ✅ done |
| 13 | [Todo tracking via `TodoProvider`](tutorial/13-todos.md) | ✅ done |
...
| 17 | [Governance via `Microsoft.AgentGovernance`](tutorial/17-governance.md) | ✅ done |
